"""
Django settings for doc_service project.
...
WSGI_APPLICATION = 'doc_service.wsgi.application'
...
GRPC_ACCOUNT_HOST = "auth_service:50051"
GRPC_HOSPITAL_HOST = "health_service:50052"
